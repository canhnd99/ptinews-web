...
public class CategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(action != null && action.equalsIgnoreCase("create")) {
			...
			if(category!=null){
				...
				if(deleted) req.setAttribute("success_message", "Category <b>" + category.getName() + "</b> has been deleted!");
				else  req.setAttribute("err_message", "Some error happend when delete category. Please check and try again!");
			} else req.setAttribute("err_message", "Category with ID = " + categoryId + " not found.");
			
			showListCategory(req, resp);
		}
		else showListCategory(req,resp);
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		if(action.equalsIgnoreCase("insert") && check){
			...
			if(cat.getName()==null){
				...
				cat.setUser_id(loggedUser.getId()); //set user_id
			...
			if(catExisted!=null) {
				...
				if(updated) req.setAttribute("success_message", "Category updated successfully!");
				else req.setAttribute("err_message", "Some error happend when update.");
				
			}
			else req.setAttribute("err_message", "Category not found!");
	...
	public void showFormCategory(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
