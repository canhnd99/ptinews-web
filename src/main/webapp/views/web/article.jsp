...
<head>
<meta charset="UTF-8">
<title>Putin nói không có động cơ khi chưa chúc mừng Biden</title>
...
<link rel="stylesheet" href='<c:url value="static/css/styleArticle.css"/>'>
</head>
<body>
	<div class="container">
        <div id="header">
        ...
        <div id="content">
            <div class="content-left">
                <div class="left-f1">
                    ...
                    <div class="cate-1">
                        ...
                        <div class="time-post">Chủ nhật, 22/11/2020, 21:22 (GMT+7)</div>
                    </div>
                    <!-- bài viết -->
                    <div class="cate-2">
                        <div class="cate-2-title">
                            <h1>Putin nói không có động cơ khi chưa chúc mừng Biden</h1>
                        </div>
                        <div class="cate-2-nd">
                            <!-- phần tóm tắt -->
                    ...
                    <div class="cate-comment">
                        ...
                        <div class="cmt">
                            <form action="" class="form-cmt">
                                <input type="textfield" placeholder="Nhập bình luận của bạn" class="nhap-cmt">
            ...
            <div class="content-right">
                <div class="fx">
                    ...
                    <div class="right-2">
                        <ul>
                            <li><a href="">Trung Quốc chúc mừng Biden</a></li>
                            <li><a href="">Cố vấn Trung Quốc cảnh báo nguy cơ quan hệ với Mỹ xấu đi thời Biden</a></li>
                            <li><a href="">Cố vấn Trung Quốc cảnh báo nguy cơ quan hệ với Mỹ xấu đi thời Biden</a></li>
                            <li><a href="">Cố vấn Trung Quốc cảnh báo nguy cơ quan hệ với Mỹ xấu đi thời Biden</a></li>
                            <li><a href="">Cố vấn Trung Quốc cảnh báo nguy cơ quan hệ với Mỹ xấu đi thời Biden</a></li>
                            <li><a href="">Cố vấn Trung Quốc cảnh báo nguy cơ quan hệ với Mỹ xấu đi thời Biden</a></li>
